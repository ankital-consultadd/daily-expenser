...
# Load environment variables from expensetrack/.env (no-op if the file is absent).
...
SECRET_KEY = "django-insecure-_3kt!mc9dxy)j5w+s48l(iix6m^c62n73&t95o68*iea=_dyba"
